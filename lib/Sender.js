...
var Sender = /** @class */ (function () {
    ...
    Sender.prototype.parseLineToUint8Array = function (line) {
        ...
        var protocol = this.fromHexString(lineItems[0]);
        var randomToken = this.fromHexString(lineItems[1]);
        var pushData = this.fromHexString(lineItems[2]);
        var gatewayMac = this.fromHexString(lineItems[3]);
        var jsonPacket = new TextEncoder().encode(lineItems[4].slice(0, -1)); // remove trailing comma
